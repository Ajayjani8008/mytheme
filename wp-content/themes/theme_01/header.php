        ...
        <div class="">
            <div class="intro-area-11">
                    ...
                    <div class="menu_area menu8">
                        <div class="container">
                            <nav class="navbar navbar-expand-lg navbar-light px-0 ">
                                <a class="navbar-brand order-sm-1 order-1" href="#"><img src="img/logo.png"
                                        alt="" /></a>
                                ...
                                <div class="collapse navbar-collapse order-md-1 justify-content-end"
                ...
                <div id="rev_slider_35_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container"
                    data-alias="slider9" data-source="gallery"
                    style="margin:0px auto;background:transparent;padding:0px;margin-top:0px;margin-bottom:0px;">
                    <!-- START REVOLUTION SLIDER 5.4.8.1 fullwidth mode -->
                    <div id="rev_slider_35_1" class="rev_slider without_overlay fullwidthabanner" style="display:none;"
                        data-version="5.4.8.1">
                        <ul>
                            <!-- SLIDE  -->
                            <li data-index="rs-72" data-transition="fade" data-slotamount="default"
                                data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default"
                                data-easeout="default" data-masterspeed="300" data-delay="8970" data-rotate="0"
                                    ...
                                    <div class="tp-caption  " id="slide-72-layer-1" data-x="" data-y="center"
                                        ...
                                        <div class="tp-caption  " id="slide-72-layer-2" data-x="100" data-y="100"
                                            ...
                                            <h1 class="tp-caption   tp-resizeme" id="slide-72-layer-4" data-x=""
                                                ...
                                                data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]"
                                                data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                                                style="z-index: 7; white-space: normal; font-size: 48px; line-height: 60px; font-weight: 600; color: #202428; letter-spacing: 0px; display: block;">
                                                Best Marketing Platform to Really <br>
                                                <span style="color: #00c18d;">Grow your Business</span>
                                            </h1>
                                            ...
                                            <div class="tp-caption   tp-resizeme" id="slide-72-layer-5" data-x=""
                                                ...
                                                data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]"
                                                data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                                                style="z-index: 8; white-space: normal; font-size: 17px; line-height: 32px; font-weight: 400; color: #202428; letter-spacing: 0px; display: block;">
                                ...
                                <div class="tp-caption   tp-resizeme rs-parallaxlevel-1" id="slide-72-layer-7"
                                    ...
                                    data-height="['none','none','none','none']" data-visibility="['on','on','on','off']"
                                    ...
                                    data-textAlign="['inherit','inherit','inherit','inherit']"
                                    data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]"
                                    data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 1;"><img
                                        src="img/slider_1.png" alt="" data-ww="700px" data-hh="585px" data-no-retina>
                                </div>
                            </li>
                        </ul>
